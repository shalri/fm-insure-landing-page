...
export default function Features() {
  return (
    <article className="pb-[9rem] sm:mx-auto sm:max-w-[1154px] sm:pb-[9.8rem]">
      ...
      <h2 className="px-4 text-center text-[3rem] leading-[1.02] -tracking-[0.6] text-ip-very-dark-violet sm:px-6 sm:text-left sm:text-[4.6rem] sm:-tracking-[0.027em]">
      ...
      <div className="mt-20 flex flex-col gap-y-[3.7rem] px-6 sm:mt-[5.75rem] sm:grid sm:grid-cols-3 sm:items-start sm:gap-x-[1.875rem] sm:gap-y-0">
        {features.map((feature) => (
          ...
          >
            ...
            <h3 className="mt-8 text-center text-[1.68rem] text-ip-very-dark-violet sm:text-left">
              {feature.heading}
            </h3>
